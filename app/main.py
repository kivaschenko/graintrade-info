...
@app.put("/items/{item_id}", response_model=ItemInResponse, tags=["Items"])
...
@app.get("/find-items-in-distance", response_model=List[ItemInResponse], tags=["Items"])
...
@app.get("/filter-items", response_model=List[ItemInResponse], tags=["Items"])
