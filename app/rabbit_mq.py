...
print(
    f"RabbitMQ connection parameters: {rabbitmq_host}, {rabbitmq_port}, {rabbitmq_username}, {rabbitmq_vhost}, {rabbitmq_queue}"
)
...
if __name__ == "__main__":
    ...
    async def publish_document_upload_event(
        ...
        queue: str = QueueName.DOC_EVENTS,
