categories = [
    (
        "Пшениця 2-го класу",
        """Пшениця 2 клас повинна відповідати вимогам ДСТУ 3768:2019 та мати наступні базисні
показники:
- вологість - базис 14%;
...
Відбір та формування проб для визначення всіх показників здійснюється згідно ДСТУ ISO 13690:2003. """,
        "Wheat 2nd grade",
        """Wheat 2nd grade must meet the requirements of DSTU 3768:2019 and have the following basic
indicators:
- moisture - basis 14%;
...
Sampling and sample formation for the determination of all indicators is carried out in accordance with DSTU ISO 13690:2003. """,
    ...
    (
        "Пшениця 3-го класу",
        """Пшениця 3 клас повинна відповідати вимогам ДСТУ 3768:2019 та мати наступні базисні
показники:
- вологість - базис 14%;
- сміттєва домішка - базис 2%;
- зернова домішка - макс 8 %,
...
Відбір та формування проб для визначення всіх показників здійснюється згідно ДСТУ ISO 13690:2003.  """,
        "Wheat 3rd grade",
        """Wheat 3rd grade must meet the requirements of DSTU 3768:2019 and have the following basic
indicators:
- moisture - basis 14%;
- trash impurity - basis 2%;
- grain impurity - max 8 %,
...
Sampling and sample formation for the determination of all indicators is carried out in accordance with DSTU ISO 13690:2003.  """,
    ...
    (
        "Пшениця 4-го класу",
        """Пшениця 4 клас повинна відповідати вимогам ДСТУ 3768:2019 та мати наступні базисні
показники:
- вологість - базис 14%;
...
Відбір та формування проб для визначення всіх показників здійснюється згідно ДСТУ ISO 13690:2003. """,
        "Wheat 4th grade",
        """Wheat 4th grade must meet the requirements of DSTU 3768:2019 and have the following basic
indicators:
...
Sampling and sample formation for the determination of all indicators is carried out in accordance with DSTU ISO 13690:2003. """,
    ...
    (
        "Ячмінь",
        """Ячмінь повинен відповідати вимогам ДСТУ 3769-98 та мати наступні базисні
показники:
- вологість - 14,0 %,
...
Відбір та формування проб для визначення всіх показників здійснюється згідно ДСТУ ISO 13690:2003. """,
        "Barley",
        """Barley must meet the requirements of DSTU 3769-98 and have the following basic
indicators:
- moisture - 14.0 %,
- trash impurity - 2.0 %,
...
Sampling and sample formation for the determination of all indicators is carried out in accordance with DSTU ISO 13690:2003. """,
    ...
    (
        "Кукурудза",
        """Кукурудза повинна відповідати вимогам ДСТУ 4525:2006 та мати наступні базисні
показники:
- вологість - 14,0%;
- сміттєва домішка - 2,0 %;
- зернова домішка - макс. 15 %;
...
Відбір та формування проб для визначення всіх показників здійснюється згідно ДСТУ ISO 13690:2003. """,
        "Corn",
        """Corn must meet the requirements of DSTU 4525:2006 and have the following basic
indicators:
- moisture - 14.0%;
- trash impurity - 2.0 %;
- grain impurity - max. 15 %;
...
Sampling and sample formation for the determination of all indicators is carried out in accordance with DSTU ISO 13690:2003. """,
    ...
    (
        "Соняшник",
        """Рекомендовані вимоги до якості згідно з ДСТУ 7011:2009. 
Тут мають враховуватися наступні показники: 
...
Не можна допускати наявність кліщів або деяких інших видів шкідників, токсичних препаратів.""",
        "Sunflower",
        """Recommended quality requirements according to DSTU 7011:2009.
The following indicators should be taken into account here:
