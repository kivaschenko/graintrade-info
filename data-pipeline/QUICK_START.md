...
### Manual Execution
```bash
cd /home/kivashchenko/Projects/graintrade-info/data-pipeline
...
If your schema already exists but Alembic revision is missing, run:
...
0 6 * * * cd /home/kivashchenko/Projects/graintrade-info/data-pipeline && source venv/bin/activate && python -m app.services.grain_forecast_pipeline >> logs/cron.log 2>&1
```
...
Type=oneshot
User=ikost
WorkingDirectory=/home/kivashchenko/Projects/graintrade-info/data-pipeline
ExecStart=/home/kivashchenko/Projects/graintrade-info/data-pipeline/venv/bin/python -m app.services.grain_forecast_pipeline
